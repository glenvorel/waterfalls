...
TIME_UNITS = [
    ...
    TimeUnit("microseconds", "µs", "usec", 1e3),
...
class Viewer:
    ...
    def _get_report_file_paths(self) -> List[str]:
        ...
        """
        report_file_paths = glob(str(self.directory_path.joinpath("waterfalls*.json").resolve()))
...
def _parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=".",
        type=str,
        help="Directory containing report file(s) generated by waterfalls.Timer. "
